---
title: Session 1:Revision of Linear Equations
...
The questions given for [preparation](https://gvgk.in/a_math_2028/0_intro/prep.html) are aimed at developing one central idea: a linear equation can be understood algebraically and geometrically. Algebraically, it describes numbers that make an equation true. Geometrically, it describes points on a straight line.
...
1. Revise the concepts of linear equations and their interpretations. Solve the 10 questions again.
2. Look up the questions given for quadratic curves and try to answer them. We will discuss these in the next session.