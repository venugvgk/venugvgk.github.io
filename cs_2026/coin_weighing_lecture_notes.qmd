---
title: "Coin Weighing Problems for Algorithms"
format:
 html:
 toc: true
...
Each candidate coin now has two hidden states—heavy or light—so the number of possibilities is \(12 \times 2 = 24\) . Since 3 weighings yield at most \(3^3 = 27\) outcomes, the counting bound says the problem might be solvable, but a valid strategy must identify both the coin and the direction of deviation .
