...
The shape is still the same as a parabola, but the vertex shifts left or right. The $x$-term changes the horizontal position of the graph, while the coefficient of $x^2$ still controls whether it opens upward or downward.

---

## 9. Effect of the coefficient of $x$

The coefficient of $x$ moves the vertex horizontally.

- In $y=x^2+2x$, the vertex is shifted to the left.
- In $y=x^2-2x$, the vertex is shifted to the right.
...
- The coefficient of $x$ shifts the graph horizontally by changing the position of the vertex.
...
- $b$ changes the horizontal position of the vertex,
