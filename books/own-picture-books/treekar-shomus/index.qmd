...
{% downloadthis file="books/own-picture-books/treekar-shomus/Treekar-Shomas-storybook.pdf" label="Download English pdf" icon="file-earmark-pdf" type="success" %}

{% downloadthis file="books/own-picture-books/treekar-shomus/treekar-shomas-telugu.pdf" label="Download Telugu pdf" icon="file-earmark-pdf" type="success" %}
