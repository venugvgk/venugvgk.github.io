...
Now, we have decided we need a page for each of the locations. Pages are created. I tried to link the pages to the title field in the .yml using [title](page link). Does not work. 

Found that <a href="page link">title</a> works. It is working now! 